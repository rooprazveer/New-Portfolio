...
import logo from '../assets/razveer.png'
import l1 from '../assets/backend.png'
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-white text-[18px] font-bold cursor-pointer flex mt-4">Razveer Singh Roop &nbsp;<span className="sm:block hidden">
            |  Portfolio
